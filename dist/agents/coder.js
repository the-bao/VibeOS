...
export class CoderAgent extends BaseAgent {
    ...
    async execute(context) {
        try {
            ...
            // Build the prompt
            const userPrompt = buildCoderPrompt(JSON.stringify(manifest, null, 2), testFailure || 'No test failures - generate initial implementation', currentCode || '// No code exists yet');
