...
`;
export function buildSpecifierPrompt(manifest, currentCode) {
    return `VibeManifest:
${manifest}
...
export function buildCoderPrompt(manifest, testResults, currentCode) {
    return `VibeManifest:
${manifest}
...
export function buildAuditorPrompt(manifest, testResults, currentCode) {
    return `VibeManifest:
${manifest}
